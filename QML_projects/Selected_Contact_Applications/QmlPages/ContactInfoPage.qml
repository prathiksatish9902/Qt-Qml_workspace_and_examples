...
Rectangle {
    ...
    Popup {
        ...
        property string editedImage: profileImage
        ...
        Column {
            ...
            TextField {
                ...
                text: editPopup.editedImage
                onTextChanged: editPopup.editedImage = text
            }
            ...
            Row {
                ...
                Button {
                    text: "Save"
                    onClicked: {
                        PhoneBookModel.updateContactByPhone(phoneNumber, editPopup.editedName, editPopup.editedPhone, editPopup.editedImage)
                        name = editPopup.editedName
                        phoneNumber = editPopup.editedPhone
                        profileImage = editPopup.editedImage
                        editPopup.close()
                    }
                }
                Button {
            ...
            ColumnLayout {
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        editPopup.editedImage = profileImage
                        editPopup.open()
                        optionMenu.close()
                    }
                }
                Button {
                    text: "Delete"
                    onClicked: {
                        PhoneBookModel.deleteContactByPhone(phoneNumber)
                        deleteButtonClicked()
                        optionMenu.close()
                    }
                }
    ...
    FileDialog {
        ...
        onAccepted: {
            profileImage = fileDialog.fileUrl.toString()
            PhoneBookModel.updateContactByPhone(phoneNumber, name, phoneNumber, profileImage)
        }
    }
}
