...
Rectangle {
    ...
    Component.onCompleted: {
        console.log("CallHistoryListPage loaded")
    }

    ColumnLayout {
        id: callHistoryHeadingColoumn
        spacing: 15
        ...
        ListView {
            id: contactList
            width: borderRectangle.width - 20
            height: borderRectangle.height - callHistoryHeadingColoumn.height - 40
            anchors.left: parent.left
            ...
            delegate: Rectangle {
                ...
                Component.onCompleted: {
                    console.log("CallHistory delegate: name=", name, "phoneNumber=", phoneNumber, "profileImage=", profileImage, "isEmpty=", profileImage === "")
                }
                ...
                RowLayout {
                    ...
                    Column {
                        ...
                        Text {
                            Layout.preferredWidth: 120
                            Layout.fillHeight: true
                            text: (incomingCall ? " ←" : "") + (outgoingCall ? " →" : "")
                            font.pixelSize: 24
                            color: "black"
                            horizontalAlignment: Text.AlignRight
                            verticalAlignment: Text.AlignVCenter
